...
<body class="bg-gray-100 font-roboto">
    <div class="flex">
        ...
        <div class="w-64 bg-white shadow-md h-screen p-4 flex flex-col justify-between">
            ...
            <div>
                <button class="bg-red-500 text-white px-4 py-2 rounded-lg shadow-lg hover:bg-red-600 flex items-center w-full">
                    ...
                    <tbody>
                        <tr>
                            <td class="py-2 px-4 border-b">
                                <img alt="Thumbnail of a t-shirt design with a cool graphic" class="w-12 h-12" height="50" src="https://storage.googleapis.com/a1aa/image/sdtsHM8eT3CziaY6oRtp_4Sjb7XdREl1JGtqxy5tgDw.jpg" width="50"/>
                            </td>
                        ...
                        <tr>
                            <td class="py-2 px-4 border-b">
                                <img alt="Thumbnail of a t-shirt design with a funny quote" class="w-12 h-12" height="50" src="https://storage.googleapis.com/a1aa/image/dlooPzacInDEJd6jyrmA90Wt3JKTGj3F9L8EIHBI9jY.jpg" width="50"/>
                            </td>
                            <td class="py-2 px-4 border-b">Funny Quote T-Shirt</td>
                        ...
                        <tr>
                            <td class="py-2 px-4 border-b">
                                <img alt="Thumbnail of a t-shirt design with a minimalist pattern" class="w-12 h-12" height="50" src="https://storage.googleapis.com/a1aa/image/kSxqJHSQGfoi_ET9IyoXZmgROTq-xsMJeCdHlR8rk0M.jpg" width="50"/>
                            </td>
                            <td class="py-2 px-4 border-b">Minimalist Pattern T-Shirt</td>
                            <td class="py-2 px-4 border-b">$22.00</td>
                            <td class="py-2 px-4 border-b">
                                <button class="bg-yellow-500 text-white px-2 py-1 rounded hover:bg-yellow-600 mr-2">
                                    Edit
                                </button>
